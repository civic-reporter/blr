...
export const translations = {
    en: {
        ...
        mobileGpsStrippedNote: "Mobile operating systems remove GPS data from photos for privacy before your browser receives them. Paste coordinates from your gallery app, use your current location, or drop a pin on the map.",
        pasteCoordinatesLabel: "Paste coordinates",
        pasteCoordinatesPlaceholder: "12.9716, 77.5946",
        pasteCoordinatesApply: "Apply coordinates",
        pasteCoordinatesHint: "Copy latitude and longitude from Google Photos or your gallery, then paste above.",
        pasteCoordinatesExamplesTitle: "Accepted formats:",
        pasteCoordinatesExample1: "12.9716, 77.5946",
        pasteCoordinatesExample2: "12.9715987, 77.5945627",
        pasteCoordinatesExample3: "lat: 12.9716, lon: 77.5946",
        pasteCoordinatesInvalid: "Could not read those coordinates. Use one of the formats shown below.",
        pasteCoordinatesOutside: "Those coordinates are outside the GBA area. Check the values or pin the map instead.",
    ...
    kn: {
        ...
        mobileGpsStrippedNote: "ಗೌಪ್ಯತೆಗಾಗಿ ಮೊಬೈಲ್ OS ಫೋಟೋಗಳಿಂದ GPS ಡೇಟಾವನ್ನು ತೆಗೆದುಹಾಕುತ್ತದೆ, ಆದ್ದರಿಂದ ಬ್ರೌಸರ್‌ಗೆ ಅವು EXIF ಇಲ್ಲದೆ ಬರುತ್ತವೆ. ಗ್ಯಾಲರಿ ಆ್ಯಪ್‌ನಿಂದ ನಿರ್ದೇಶಾಂಕಗಳನ್ನು ಅಂಟಿಸಿ, ನಿಮ್ಮ ಪ್ರಸ್ತುತ ಸ್ಥಳವನ್ನು ಬಳಸಿ, ಅಥವಾ ನಕ್ಷೆಯಲ್ಲಿ ಪಿನ್ ಇರಿಸಿ.",
        pasteCoordinatesLabel: "ನಿರ್ದೇಶಾಂಕಗಳನ್ನು ಅಂಟಿಸಿ",
        pasteCoordinatesPlaceholder: "12.9716, 77.5946",
        pasteCoordinatesApply: "ನಿರ್ದೇಶಾಂಕಗಳನ್ನು ಅನ್ವಯಿಸಿ",
        pasteCoordinatesHint: "Google Photos ಅಥವಾ ಗ್ಯಾಲರಿಯಿಂದ ಅಕ್ಷಾಂಶ/ರೇಖಾಂಶವನ್ನು ನಕಲಿಸಿ, ಮೇಲೆ ಅಂಟಿಸಿ.",
        pasteCoordinatesExamplesTitle: "ಸ್ವೀಕಾರಾರ್ಹ ಸ್ವರೂಪಗಳು:",
        pasteCoordinatesExample1: "12.9716, 77.5946",
        pasteCoordinatesExample2: "12.9715987, 77.5945627",
        pasteCoordinatesExample3: "lat: 12.9716, lon: 77.5946",
        pasteCoordinatesInvalid: "ಆ ನಿರ್ದೇಶಾಂಕಗಳನ್ನು ಓದಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ಕೆಳಗೆ ತೋರಿಸಿರುವ ಸ್ವರೂಪಗಳಲ್ಲಿ ಒಂದನ್ನು ಬಳಸಿ.",
        pasteCoordinatesOutside: "ಆ ನಿರ್ದೇಶಾಂಕಗಳು GBA ಪ್ರದೇಶದ ಹೊರಗಿವೆ. ಮೌಲ್ಯಗಳನ್ನು ಪರಿಶೀಲಿಸಿ ಅಥವಾ ನಕ್ಷೆಯಲ್ಲಿ ಪಿನ್ ಇರಿಸಿ.",
