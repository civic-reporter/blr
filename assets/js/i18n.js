...
export const translations = {
    en: {
        ...
        uploadInstructions: "Choose a photo from your gallery to keep GPS tags, or use the camera if you are on site. If location is missing, tap the map to set it. Then confirm the photo, pick the issue type, and post.",
        ...
        whatsappPhotoNote: "Opens WhatsApp to the number above with your complaint text ready — attach civic-issue.jpg and tap Send.",
    ...
    kn: {
        ...
        uploadInstructions: "GPS ಟ್ಯಾಗ್‌ಗಳನ್ನು ಉಳಿಸಲು ಗ್ಯಾಲರಿಯಿಂದ ಫೋಟೋ ಆಯ್ಕೆಮಾಡಿ, ಅಥವಾ ಸ್ಥಳದಲ್ಲಿದ್ದರೆ ಕ್ಯಾಮೆರಾ ಬಳಸಿ. ಸ್ಥಳ ಕಾಣೆಯಾದರೆ ನಕ್ಷೆಯಲ್ಲಿ ಹೊಂದಿಸಿ. ಫೋಟೋ ದೃಢೀಕರಿಸಿ, ಸಮಸ್ಯೆ ಆಯ್ಕೆ ಮಾಡಿ, ನಂತರ ಸಲ್ಲಿಸಿ.",
