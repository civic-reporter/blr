...
export const translations = {
    en: {
        ...
        stepDetailsSub: "Next, WhatsApp opens with your complaint text. Your photo is downloaded to this device — you must attach that photo in WhatsApp before sending.",
        ...
        issueReportedFollowUp: "WhatsApp should have opened with your complaint text, and the photo should have downloaded to your device. Attach that downloaded photo in the chat, then tap Send.",
        issueReportedResendHint: "WhatsApp did not open, or you need the photo again? Tap below to re-download and retry.",
        ...
        escalationContactsHint: "If your complaint is not addressed, escalate to these corporation and zone officers:",
        escalationCorpOfficers: "Corporation officers",
        escalationZoneOfficers: "Zone officers",
        escalationPreviewCopy: "Need officer contacts first? View escalation contacts for this location without opening WhatsApp.",
        viewEscalationContacts: "View escalation contacts",
        hideEscalationContacts: "Hide escalation contacts",
        escalationContactsLoading: "Loading escalation contacts…",
        escalationContactsNeedLocation: "Set the map pin on the Location step first to see officers for this area.",
        escalationContactsUnavailable: "Escalation contacts are not available for this location yet.",
        ...
        whatsappPhotoNote: "When you tap Send via WhatsApp: (1) your photo downloads to this phone/computer, (2) WhatsApp opens with the complaint text, (3) you must attach the downloaded photo to the chat, then tap Send. WhatsApp cannot attach the photo automatically.",
        whatsappAttachCallout: "Important: the photo will download to your device. Attach that downloaded photo in WhatsApp with your complaint — it is not sent automatically.",
    ...
    kn: {
        ...
        stepDetailsSub: "ಮುಂದೆ WhatsApp ನಿಮ್ಮ ದೂರು ಪಠ್ಯದೊಂದಿಗೆ ತೆರೆಯುತ್ತದೆ. ಫೋಟೋ ಈ ಸಾಧನಕ್ಕೆ ಡೌನ್‌ಲೋಡ್ ಆಗುತ್ತದೆ — ಕಳುಹಿಸುವ ಮೊದಲು ಆ ಫೋಟೋವನ್ನು WhatsApp ನಲ್ಲಿ ಲಗತ್ತಿಸಬೇಕು.",
        ...
        issueReportedFollowUp: "WhatsApp ದೂರು ಪಠ್ಯದೊಂದಿಗೆ ತೆರೆಯಲಾಗಿರಬೇಕು, ಮತ್ತು ಫೋಟೋ ನಿಮ್ಮ ಸಾಧನಕ್ಕೆ ಡೌನ್‌ಲೋಡ್ ಆಗಿರಬೇಕು. ಆ ಡೌನ್‌ಲೋಡ್ ಫೋಟೋವನ್ನು ಚಾಟ್‌ಗೆ ಲಗತ್ತಿಸಿ, ನಂತರ Send ಒತ್ತಿ.",
        issueReportedResendHint: "WhatsApp ತೆರೆಯಲಿಲ್ಲವೇ, ಅಥವಾ ಫೋಟೋ ಬೇಕೇ? ಮತ್ತೆ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ ಪ್ರಯತ್ನಿಸಲು ಕೆಳಗೆ ಒತ್ತಿ.",
        ...
        escalationCorpOfficers: "ನಗರ ನಿಗಮ ಅಧಿಕಾರಿಗಳು",
        escalationZoneOfficers: "ವಲಯ ಅಧಿಕಾರಿಗಳು",
        escalationPreviewCopy: "ಮೊದಲು ಅಧಿಕಾರಿ ಸಂಪರ್ಕಗಳು ಬೇಕೇ? WhatsApp ತೆರೆಯದೆಯೇ ಈ ಸ್ಥಳದ ಎಸ್ಕಲೇಷನ್ ಸಂಪರ್ಕಗಳನ್ನು ನೋಡಿ.",
        viewEscalationContacts: "ಎಸ್ಕಲೇಷನ್ ಸಂಪರ್ಕಗಳನ್ನು ನೋಡಿ",
        hideEscalationContacts: "ಎಸ್ಕಲೇಷನ್ ಸಂಪರ್ಕಗಳನ್ನು ಮರೆಮಾಡಿ",
        escalationContactsLoading: "ಎಸ್ಕಲೇಷನ್ ಸಂಪರ್ಕಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ…",
        escalationContactsNeedLocation: "ಈ ಪ್ರದೇಶದ ಅಧಿಕಾರಿಗಳನ್ನು ನೋಡಲು ಮೊದಲು Location ಹಂತದಲ್ಲಿ ನಕ್ಷೆ ಪಿನ್ ಹೊಂದಿಸಿ.",
        escalationContactsUnavailable: "ಈ ಸ್ಥಳಕ್ಕೆ ಎಸ್ಕಲೇಷನ್ ಸಂಪರ್ಕಗಳು ಇನ್ನೂ ಲಭ್ಯವಿಲ್ಲ.",
        ...
        whatsappPhotoNote: "Send via WhatsApp ಒತ್ತಿದಾಗ: (1) ಫೋಟೋ ಈ ಸಾಧನಕ್ಕೆ ಡೌನ್‌ಲೋಡ್ ಆಗುತ್ತದೆ, (2) ದೂರು ಪಠ್ಯದೊಂದಿಗೆ WhatsApp ತೆರೆಯುತ್ತದೆ, (3) ಡೌನ್‌ಲೋಡ್ ಫೋಟೋವನ್ನು ಚಾಟ್‌ಗೆ ಲಗತ್ತಿಸಿ Send ಒತ್ತಿ. WhatsApp ಫೋಟೋವನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಲಗತ್ತಿಸುವುದಿಲ್ಲ.",
        whatsappAttachCallout: "ಮುಖ್ಯ: ಫೋಟೋ ನಿಮ್ಮ ಸಾಧನಕ್ಕೆ ಡೌನ್‌ಲೋಡ್ ಆಗುತ್ತದೆ. ದೂರಿನೊಂದಿಗೆ ಆ ಡೌನ್‌ಲೋಡ್ ಫೋಟೋವನ್ನು WhatsApp ನಲ್ಲಿ ಲಗತ್ತಿಸಿ — ಅದು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಕಳುಹಿಸಲ್ಪಡುವುದಿಲ್ಲ.",
    ...
    ml: {
        ...
        stepDetailsSub: "അടുത്തതായി WhatsApp പരാതി ടെക്സ്റ്റുമായി തുറക്കും. ഫോട്ടോ ഈ ഉപകരണത്തിലേക്ക് ഡൗൺലോഡ് ചെയ്യും — അയയ്ക്കുന്നതിന് മുമ്പ് ആ ഫോട്ടോ WhatsApp-ൽ അറ്റാച്ച് ചെയ്യണം.",
        ...
        issueReportedFollowUp: "WhatsApp പരാതി ടെക്സ്റ്റുമായി തുറന്നിരിക്കണം, ഫോട്ടോ ഉപകരണത്തിലേക്ക് ഡൗൺലോഡ് ചെയ്തിരിക്കണം. ആ ഡൗൺലോഡ് ഫോട്ടോ ചാറ്റിൽ അറ്റാച്ച് ചെയ്ത് Send അമർത്തുക.",
        issueReportedResendHint: "WhatsApp തുറന്നില്ലേ, അല്ലെങ്കിൽ ഫോട്ടോ വീണ്ടും വേണോ? താഴെ ടാപ്പ് ചെയ്ത് വീണ്ടും ഡൗൺലോഡ് ചെയ്ത് ശ്രമിക്കുക.",
        ...
        escalationCorpOfficers: "കോർപ്പറേഷൻ ഉദ്യോഗസ്ഥർ",
        escalationZoneOfficers: "സോൺ ഉദ്യോഗസ്ഥർ",
        escalationPreviewCopy: "ആദ്യം ഉദ്യോഗസ്ഥ കോൺടാക്റ്റുകൾ വേണോ? WhatsApp തുറക്കാതെ ഈ സ്ഥലത്തിന്റെ എസ്കലേഷൻ കോൺടാക്റ്റുകൾ കാണുക.",
        viewEscalationContacts: "എസ്കലേഷൻ കോൺടാക്റ്റുകൾ കാണുക",
        hideEscalationContacts: "എസ്കലേഷൻ കോൺടാക്റ്റുകൾ മറയ്ക്കുക",
        escalationContactsLoading: "എസ്കലേഷൻ കോൺടാക്റ്റുകൾ ലോഡ് ചെയ്യുന്നു…",
        escalationContactsNeedLocation: "ഈ പ്രദേശത്തെ ഉദ്യോഗസ്ഥരെ കാണാൻ ആദ്യം Location ഘട്ടത്തിൽ മാപ്പ് പിൻ സജ്ജമാക്കുക.",
        escalationContactsUnavailable: "ഈ സ്ഥലത്തിന് എസ്കലേഷൻ കോൺടാക്റ്റുകൾ ഇപ്പോൾ ലഭ്യമല്ല.",
