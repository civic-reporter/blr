...
export const translations = {
    en: {
        ...
        uploadInstructions: "Choose a photo from your gallery or files. GPS location is read from the photo when available — if missing, tap the map to set it. Then confirm the photo, pick the issue type, and post.",
    ...
    kn: {
        ...
        uploadInstructions: "ನಿಮ್ಮ ಗ್ಯಾಲರಿ ಅಥವಾ ಫೈಲ್‌ಗಳಿಂದ ಫೋಟೋ ಆಯ್ಕೆಮಾಡಿ. ಲಭ್ಯವಿದ್ದರೆ GPS ಫೋಟೋದಿಂದ ಓದಲಾಗುತ್ತದೆ — ಇಲ್ಲದಿದ್ದರೆ ನಕ್ಷೆಯಲ್ಲಿ ಸ್ಥಳ ಸೇರಿಸಿ. ಫೋಟೋ ದೃಢೀಕರಿಸಿ, ಸಮಸ್ಯೆ ಆಯ್ಕೆ ಮಾಡಿ, ನಂತರ ಸಲ್ಲಿಸಿ.",
