...
export const translations = {
    en: {
        ...
        issuePostedDesc: "Choose WhatsApp in the share menu to send the photo and complaint together.",
        ...
        whatsappReviewAndSend: "WhatsApp opened with your complaint ready — review and tap Send.",
        whatsappReviewAndAttach: "WhatsApp opened with your complaint ready — attach civic-issue.jpg, then tap Send.",
        whatsappShareWithPhoto: "Choose WhatsApp in the share menu — the photo and complaint text are attached.",
        whatsappDownloadAttach: "Photo saved as civic-issue.jpg and WhatsApp opened — attach the photo, then tap Send.",
        whatsappCancelled: "WhatsApp share was cancelled.",
        whatsappPhotoNote: "On mobile, share photo + text via WhatsApp. Otherwise attach civic-issue.jpg after WhatsApp opens.",
    ...
    kn: {
        ...
        issuePostedDesc: "ಫೋಟೋ ಮತ್ತು ದೂರು ಒಟ್ಟಿಗೆ ಕಳುಹಿಸಲು ಶೇರ್ ಮೆನುವಿನಲ್ಲಿ WhatsApp ಆಯ್ಕೆಮಾಡಿ.",
        ...
        whatsappReviewAndSend: "WhatsApp ನಿಮ್ಮ ದೂರು ಸಿದ್ಧವಾಗಿ ತೆರೆಯಲಾಗಿದೆ — ಪರಿಶೀಲಿಸಿ Send ಒತ್ತಿರಿ.",
        whatsappReviewAndAttach: "WhatsApp ನಿಮ್ಮ ದೂರು ಸಿದ್ಧವಾಗಿ ತೆರೆಯಲಾಗಿದೆ — civic-issue.jpg ಲಗತ್ತಿಸಿ Send ಒತ್ತಿರಿ.",
        whatsappShareWithPhoto: "ಶೇರ್ ಮೆನುವಿನಲ್ಲಿ WhatsApp ಆಯ್ಕೆಮಾಡಿ — ಫೋಟೋ ಮತ್ತು ದೂರು ಪಠ್ಯ ಲಗತ್ತಾಗಿರುತ್ತದೆ.",
        whatsappDownloadAttach: "civic-issue.jpg ಉಳಿಸಲಾಗಿದೆ ಮತ್ತು WhatsApp ತೆರೆಯಲಾಗಿದೆ — ಫೋಟೋ ಲಗತ್ತಿಸಿ Send ಒತ್ತಿರಿ.",
        whatsappCancelled: "WhatsApp ಶೇರ್ ರದ್ದಾಗಿದೆ.",
        whatsappPhotoNote: "ಮೊಬೈಲ್‌ನಲ್ಲಿ WhatsApp ಮೂಲಕ ಫೋಟೋ + ಪಠ್ಯ ಶೇರ್ ಮಾಡಿ. ಅಲ್ಲದಿದ್ದರೆ WhatsApp ತೆರೆದ ನಂತರ civic-issue.jpg ಲಗತ್ತಿಸಿ.",
