...
export const translations = {
    en: {
        ...
        whatsappDirectWithPhoto: "WhatsApp opened to {number}. Attach civic-issue.jpg, review your message, then tap Send.",
        whatsappReviewAndAttach: "WhatsApp opened to {number} — attach civic-issue.jpg, then tap Send.",
        whatsappShareWithPhoto: "WhatsApp opened to {number} with your complaint ready — review and tap Send.",
        whatsappDownloadAttach: "WhatsApp opened to {number}. Attach civic-issue.jpg, review your message, then tap Send.",
        whatsappCancelled: "WhatsApp share was cancelled.",
        whatsappPhotoNote: "Opens WhatsApp to the number above with your complaint text ready — attach civic-issue.jpg, then tap Send.",
    ...
    kn: {
        ...
        whatsappDirectWithPhoto: "WhatsApp {number} ಗೆ ತೆರೆಯಲಾಗಿದೆ. civic-issue.jpg ಲಗತ್ತಿಸಿ, ಸಂದೇಶ ಪರಿಶೀಲಿಸಿ, ನಂತರ Send ಒತ್ತಿರಿ.",
        whatsappReviewAndAttach: "WhatsApp {number} ಗೆ ತೆರೆಯಲಾಗಿದೆ — civic-issue.jpg ಲಗತ್ತಿಸಿ Send ಒತ್ತಿರಿ.",
        whatsappShareWithPhoto: "WhatsApp {number} ಗೆ ನಿಮ್ಮ ದೂರು ಸಿದ್ಧವಾಗಿ ತೆರೆಯಲಾಗಿದೆ — ಪರಿಶೀಲಿಸಿ Send ಒತ್ತಿರಿ.",
        whatsappDownloadAttach: "WhatsApp {number} ಗೆ ತೆರೆಯಲಾಗಿದೆ. civic-issue.jpg ಲಗತ್ತಿಸಿ, ಸಂದೇಶ ಪರಿಶೀಲಿಸಿ, ನಂತರ Send ಒತ್ತಿರಿ.",
        whatsappCancelled: "WhatsApp ಶೇರ್ ರದ್ದಾಗಿದೆ.",
        whatsappPhotoNote: "ಮೇಲಿನ ಸಂಖ್ಯೆಗೆ ದೂರು ಪಠ್ಯ ಸಿದ್ಧವಾಗಿ WhatsApp ತೆರೆಯುತ್ತದೆ — civic-issue.jpg ಲಗತ್ತಿಸಿ Send ಒತ್ತಿರಿ.",
